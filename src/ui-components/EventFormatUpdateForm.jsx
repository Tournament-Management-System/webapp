...
export default function EventFormatUpdateForm(props) {
  const {
    id: idProp,
    eventFormat,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = eventFormatRecord
      ? { ...initialValues, ...eventFormatRecord }
      : initialValues;
  ...
  const [eventFormatRecord, setEventFormatRecord] = React.useState(eventFormat);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(EventFormat, idProp)
        : eventFormat;
      setEventFormatRecord(record);
    };
    queryData();
  }, [idProp, eventFormat]);
  React.useEffect(resetStateValues, [eventFormatRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            EventFormat.copyOf(eventFormatRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "EventFormatUpdateForm")}
      {...rest}
    >
      <ArrayField
