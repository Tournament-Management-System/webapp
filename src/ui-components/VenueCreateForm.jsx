...
export default function VenueCreateForm(props) {
  ...
  const [venueType, setVenueType] = React.useState(initialValues.venueType);
  const [rooms, setRooms] = React.useState(initialValues.rooms);
  const [address, setAddress] = React.useState(initialValues.address);
  const [errors, setErrors] = React.useState({});
  const resetStateValues = () => {
    setName(initialValues.name);
    setVenueType(initialValues.venueType);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.venueType ?? value;
          }
          if (errors.venueType?.hasError) {
            runValidationTasks("venueType", value);
          }
          setVenueType(value);
        }}
        onBlur={() => runValidationTasks("venueType", venueType)}
        errorMessage={errors.venueType?.errorMessage}
        hasError={errors.venueType?.hasError}
        {...getOverrideProps(overrides, "venueType")}
      ></TextField>
      <ArrayField
