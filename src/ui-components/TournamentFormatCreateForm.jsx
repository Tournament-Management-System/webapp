...
export default function TournamentFormatCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setEventFee(initialValues.eventFee);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TournamentFormat(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TournamentFormatCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
