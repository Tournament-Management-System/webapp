...
export default function TournamentStateCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setTournamentFormatId(initialValues.tournamentFormatId);
    setEventFormatIds(initialValues.eventFormatIds);
    setCurrentEventFormatIdsValue("");
    setCompetitors(initialValues.competitors);
    setJudges(initialValues.judges);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TournamentState(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TournamentStateCreateForm")}
      {...rest}
    >
      <TextField
